...
def dao_create_category(db, category_object, user_id, category_name, category_description):
    new_category = category_object(user_id=user_id, category_name=category_name, category_description=category_description)
