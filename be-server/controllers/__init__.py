...
def controller_create_user(db, user_object, budget_object, category_object, eco_goal_object, json_data):
    try:
        data = service_create_user(db, user_object, budget_object, category_object, eco_goal_object, json_data)
        return data
